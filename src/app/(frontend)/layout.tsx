      ...
      <body className="min-h-screen bg-white text-gray-900 antialiased">
        ...
        <footer className="mt-16 bg-black text-white">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
            <p className="text-gray-400">© {new Date().getFullYear()} Cercle des Administrateurs Publics du Sénégal</p>
            <p className="text-gray-600">Plateforme gérée avec Payload CMS</p>
          </div>
        </footer>
      </body>
    </html>
