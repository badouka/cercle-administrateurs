...
import { POLITIQUE_CONFIDENTIALITE_DEFAUT } from '@/lib/contenu-legal'

const SLUG         = 'politique-confidentialite'
const TITRE_DEFAUT = 'Politique de Confidentialité'
...
export default async function PolitiqueConfidentialitePage() {
  ...
  const html     = htmlBase.replace(/<[^>]*>/g, '').trim().length > 0
    ? htmlBase
    : lexicalToHtml(POLITIQUE_CONFIDENTIALITE_DEFAUT)
