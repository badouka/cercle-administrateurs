        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="animate-fade-left">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href="/inscription"
                  className="inline-flex items-center gap-2 rounded-lg bg-[#1a7a3a] px-7 py-3 font-semibold text-white transition-colors hover:bg-[#1a7a3a]/90"
                >
                  Devenir membre <ArrowRight size={18} />
                </Link>
                <Link
                  href="/a-propos"
                  className="inline-flex items-center rounded-lg border-2 border-[#1a7a3a] px-7 py-3 font-semibold text-[#1a7a3a] transition-colors hover:bg-[#1a7a3a]/5"
                >
                  Découvrir le Cercle
                </Link>
              </div>
            ...
            <div className="relative animate-fade-right">
              ...
              <div className="absolute -bottom-6 -left-6 rounded-xl border-t-4 border-[#C8A24A] bg-white p-4 shadow-xl">
                <p className="font-serif text-3xl font-bold text-[#1a7a3a]">30+</p>
          ...
          <div className="mt-20 grid grid-cols-2 border-t border-b border-[#C8A24A]/30 bg-white sm:grid-cols-4">
            {[
              ...
              >
                <p className="font-serif text-4xl text-[#1a7a3a]">{chiffre}</p>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-8 px-6 lg:grid-cols-[500px_1fr]">
            ...
            <div className="relative aspect-[3/4] w-full overflow-hidden rounded-2xl bg-[#FAF8F3] shadow-xl">
              {presidentPhoto ? (
                ...
                <div className="flex h-full w-full items-center justify-center">
                  <User size={56} className="text-[#1a7a3a]/20" />
                </div>
              )}
          ...
          <div>
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-lg bg-[#1a7a3a] px-6 py-3 font-semibold text-white transition-colors hover:bg-[#1a7a3a]/90"
            >
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <Link
              href="/actualites"
              className="inline-flex items-center gap-2 font-semibold text-[#1a7a3a] transition-colors hover:text-[#1a7a3a]/70"
            >
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_380px]">
              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[16/10] overflow-hidden bg-[#1a7a3a]/5">
                      {imageUrl && (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img
                          src={imageUrl}
                    ...
                    <div className="p-6">
                      <span className="inline-block rounded-full bg-[#1a7a3a]/10 px-3 py-1 text-xs font-medium text-[#1a7a3a]">
                      ...
                      <span className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[#1a7a3a]">
                ...
                {actuSecondaires.length === 0 ? (
                  ...
                  actuSecondaires.map(actu => {
                    ...
                    return (
                      ...
                      >
                        <div className="h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg bg-[#1a7a3a]/5">
                          {imageUrl && (
                            // eslint-disable-next-line @next/next/no-img-element
                            <img
                              src={imageUrl}
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex items-start justify-between gap-6">
            ...
            <Link
              href="/magazines"
              className="flex flex-shrink-0 items-center gap-1 text-sm font-semibold text-[#1a7a3a] transition-colors hover:text-[#1a7a3a]/70"
            >
          ...
          {magazine ? (
              ...
              <div className="mt-10 grid overflow-hidden rounded-2xl border border-[#14110B]/10 bg-white shadow-sm lg:grid-cols-2">
                ...
                <div className="relative min-h-[350px] lg:min-h-[400px] overflow-hidden bg-[#FAF8F3]">
                  {couverture?.url ? (
                    ...
                    <div className="absolute inset-0 bg-[#1a7a3a]" />
                  )}
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {magazineFichier ? (
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-[#1a7a3a] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#1a7a3a]/90"
                      >
                    ...
                    {magazineFichier && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 rounded-lg border border-[#14110B]/20 px-6 py-2.5 text-sm font-semibold text-[#14110B] transition-colors hover:border-[#1a7a3a] hover:text-[#1a7a3a]"
                      >
                    ...
                    return (
                      ...
                      >
                        {cov?.url ? (
                          ...
                          <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-[#1a7a3a]/10">
                            <FileText size={20} className="text-[#1a7a3a]/40" strokeWidth={1.5} />
                          </div>
                        )}
                        <div className="min-w-0">
            ...
            <div className="mt-10 rounded-2xl border border-[#14110B]/10 bg-white p-10 text-center shadow-sm">
              ...
              <Link
                href="/magazines"
                className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[#1a7a3a] hover:underline"
              >
      ...
      <section className="bg-[#FAF8F3] py-16">
        <div className="mx-auto max-w-3xl rounded-3xl border border-[#1a7a3a]/10 bg-white p-12 text-center shadow-lg">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/inscription"
              className="inline-flex items-center gap-2 rounded-lg bg-[#1a7a3a] px-8 py-3 font-semibold text-white transition-colors hover:bg-[#1a7a3a]/90"
            >
              Faire une demande d&apos;adhésion <ArrowRight size={18} />
            </Link>
            <Link
              href="/a-propos"
              className="inline-flex items-center rounded-lg border border-[#1a7a3a] px-8 py-3 font-semibold text-[#1a7a3a] transition-colors hover:bg-[#1a7a3a]/5"
            >
              En savoir plus
            </Link>
          </div>
