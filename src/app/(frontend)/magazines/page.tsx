                ...
                return (
                  <div key={mag.id} className="group cursor-pointer bg-white rounded-2xl border border-[#14110B]/10 hover:border-[#C9A227]/50 hover:shadow-md transition-all p-3">
                    ...
                    >
                      ...
                      {/* Titre (cliquable) */}
                      <h3 className="mt-3 px-1 font-serif font-bold text-[#14110B] text-sm leading-tight line-clamp-2 hover:text-[#14b53a] transition-colors cursor-pointer">
                        {mag.titre}
                      </h3>
                    </Link>
                    ...
                    <div className="flex justify-between items-center mt-2 px-1">
                      ...
                      {fichier?.url ? (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold text-[#14b53a] hover:underline"
                        >
                          Lire →
                        </a>
                      ) : (
                        <span className="text-xs font-semibold text-[#14b53a]">Lire →</span>
                      )}
                    </div>
                  </div>
                )
