      ...
      <section className="mx-auto max-w-3xl px-6 pb-20">
        <div className="flex flex-wrap items-center justify-between gap-6 border-t border-[#14110B]/10 pt-8">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#C8A24A] bg-[#1a7a3a]/10 text-lg font-bold text-[#1a7a3a]">
              {presidentInitiales}
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-[#14110B]/15 text-[#14110B]/50 transition-colors hover:border-[#1a7a3a] hover:bg-[#1a7a3a] hover:text-white"
            >
