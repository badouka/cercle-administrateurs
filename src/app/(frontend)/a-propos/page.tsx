        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-start gap-16 lg:grid-cols-2">
            ...
            <div className="relative pl-6">
              <span className="absolute left-0 top-2 bottom-2 w-0.5 bg-gradient-to-b from-[#14b53a] to-[#C9A227]" />
      ...
      <section className="bg-white pb-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="relative overflow-hidden rounded-2xl border border-[#BFDDCD] bg-[#EEF6F1] p-10">
            ...
            />
            <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[#14b53a] to-[#C9A227]" />
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div>
              ...
              <Link
                href="/inscription"
                className="mt-8 inline-flex items-center gap-2 rounded-lg bg-[#14b53a] px-7 py-3 font-semibold text-white transition-colors hover:bg-[#14b53a]/90"
              >
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {ENGAGEMENTS.map(({ Icon, titre, texte }) => (
              <div
                key={titre}
                className="rounded-2xl border border-[#14110B]/10 border-t-4 border-t-[#14b53a] bg-white p-7 transition-shadow hover:shadow-md"
              >
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-[#BFDDCD] bg-[#EEF6F1] text-[#14b53a]">
                  <Icon size={22} />
                </div>
