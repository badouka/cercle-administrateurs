...
const TITRE_COLONNE = 'mb-4 font-mono text-xs uppercase tracking-widest text-[#C8A24A] font-bold'
const LIEN_COLONNE = 'text-sm text-[#14110B]/70 transition-colors hover:text-[#1a7a3a]'
      ...
      <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-col gap-3 items-start">
            {logoError ? (
              <div className="flex items-center gap-2">
                <span className="rounded bg-[#1a7a3a] px-2 py-1 text-sm font-black text-white">CAP</span>
              </div>
            ) : (
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-3 border-t border-[#14110B]/10 pt-8 text-xs text-[#14110B]/40 sm:flex-row">
          <p className="text-xs text-[#14110B]/40 text-center">
            ...
            <a href="https://digissol.com/" target="_blank" rel="noopener noreferrer" className="text-[#1a7a3a] font-semibold hover:text-[#C8A24A] transition-colors underline">
              DIGISSOL
            </a>
          </p>
        </div>
