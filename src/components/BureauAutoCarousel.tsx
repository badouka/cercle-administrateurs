    ...
    <section className="bg-[#F5F4EF] py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <p className="font-mono text-xs uppercase tracking-widest text-[#1a7a3a]">
            ...
            {maxIndex > 0 && (
              <div className="mt-8 flex items-center justify-center gap-4">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-ink/15 text-ink transition-colors hover:border-[#1a7a3a] hover:text-[#1a7a3a]"
                >
                  <ChevronLeft size={18} />
                </button>
                <button
        ...
        <div className="mt-10 text-center">
          <Link
            href="/annuaire"
            className="inline-flex items-center gap-2 rounded-lg bg-[#1a7a3a] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1a7a3a]/90"
          >
