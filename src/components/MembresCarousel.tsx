              ...
              {group.map(membre => {
                ...
                return (
                  <Link
                    ...
                    className="block cursor-pointer overflow-hidden rounded-2xl border border-[#14110B]/10 bg-white transition-colors hover:border-[#C8A24A]/50"
                  >
                    <div className="relative aspect-[3/4] overflow-hidden">
                      {membre.photo ? (
                        ...
                        <div className="flex h-full w-full items-center justify-center bg-[#1a7a3a]/10">
                          <span className="font-serif text-3xl font-bold text-[#1a7a3a]">
                    ...
                    <div className="p-4">
                      ...
                      <p className="mt-1 font-mono text-xs uppercase tracking-wider text-[#C8A24A]">
                        {posteCap || 'MEMBRE'}
                      </p>
                      {organisme && (
      ...
      {pageCount > 1 && (
        <>
          <button
            ...
            className="absolute left-0 top-1/2 z-10 flex h-10 w-10 -translate-x-4 -translate-y-1/2 items-center justify-center rounded-full border border-[#14110B]/10 bg-white shadow-md transition-colors hover:border-[#C8A24A] disabled:opacity-40"
          >
          ...
          <button
            ...
            aria-label="Suivant"
            className="absolute right-0 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 translate-x-4 items-center justify-center rounded-full border border-[#14110B]/10 bg-white shadow-md transition-colors hover:border-[#C8A24A] disabled:opacity-40"
          >
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            {pages.map((_, i) => (
              <button
                ...
                className={
                  i === page
                    ? 'h-2 w-6 rounded-full bg-[#C8A24A]'
