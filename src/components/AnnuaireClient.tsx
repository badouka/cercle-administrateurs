        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-4">
          {filtered.map(m => (
            <Link
              ...
              className="relative cursor-pointer overflow-hidden rounded-2xl border border-[#14110B]/10 border-t-4 border-t-[#0B6B3A] bg-white transition-all hover:border-[#C8A24A]/50 hover:shadow-md"
            >
              {m.isBureau ? (
