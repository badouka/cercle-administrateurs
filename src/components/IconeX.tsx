// Logo X (ex-Twitter). Le glyphe « 𝕏 » (U+1D54F) n'est présent dans aucune des
// polices du site : il faut passer par le tracé SVG.
export function IconeX({ size = 12 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
